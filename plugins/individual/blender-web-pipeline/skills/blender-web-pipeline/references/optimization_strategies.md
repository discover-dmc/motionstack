...
- Use JPEG or WEBP for diffuse maps (lossy, smaller)
- Use PNG for alpha/normal maps (lossless)
- Target resolution: 512-1024px
- For GPU-native compression (KTX2/Basis Universal) or meshopt geometry compression, post-process the exported .glb with `gltfpack` — Blender's exporter doesn't produce these natively yet
